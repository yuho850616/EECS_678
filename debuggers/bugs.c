...
void echoohce(char** strs) {
	...
	for (; iter != stop_beginning; --iter) // NULL change to stop_beginning
		printf("%s ", *iter);
...
int main(int argc, char** argv) {
  ...
  bug_info.num_bugs_on_mars = 0; // move from to front to delcare before use it.
